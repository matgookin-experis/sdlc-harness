...
- **City search** — Enter any city name and click Search (or press Enter) to see mock
...
This project follows the IBM Hackathon security template. Before every commit, verify:
